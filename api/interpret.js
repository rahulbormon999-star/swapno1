...
// এতে system prompt থেকে ক্যাটাগরি-সংক্রান্ত নির্দেশনা বাদ দেওয়া গেছে (prompt tokens কমেছে),
// এবং AI-কে আর প্রতি উত্তরে অতিরিক্ত ট্যাগ বসাতে হয় না (completion tokens কমেছে)।
const CATEGORY_KEYWORDS = [
  ...
  ['তাড়া করা', ['taara korche', 'taara kore', 'pichu nieche', 'dhawa', 'তাড়া করছে', 'তাড়া করে', 'পিছু নিয়েছে', 'ধাওয়া']],
...
(ক) ও (খ) এর জন্য কাঠামো — শুধু **বোল্ড** টেক্সট:
**স্বপ্নের মূল বার্তা:**
**প্রতীক ও ব্যাখ্যা:**
...
function classifyInput(dreamText) {
  ...
  return 'new_dream'; // ডিফল্ট হিসেবে 'new_dream' ধরে নেওয়া হবে, কারণ 'context_answer' logic বাদ দেওয়া হয়েছে
}
...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (dream.length > 2000) {
      return res.status(400).json({ error: 'আপনার লেখা ২০ অক্ষ
